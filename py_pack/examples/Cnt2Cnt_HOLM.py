#-----------------------------------------------------------------------------#
# This file is a basic test of the integration computation constraint,
# build by the optimiation build class and functions defOptVarsConsts
# It basically:
#   ......
#-----------------------------------------------------------------------------#
...
optProb.addContactEndEffVars(ee_name)
...
forceCnt, forceCoefCnt = optProb.getContactEndEffVars(ee_name)
...
# time bounds
dtlbx = [0]*timeDelta.size1()
dtubx = [0.5]*timeDelta.size1()
...
lbx =  Xlbx + dXlbx + dtlbx + fCntlbx + fcoefCntlbx
ubx =  Xubx + dXubx + dtubx + fCntubx + fcoefCntubx
...
p = [3*ca.pi/2, goalX, goalY, goalPhi, 0,0,10, 0,50,10] #[ca.pi + ca.pi/4]
...
animTraj.animationfunc1Hand(pos3D[0,:], pos3D[1,:], pos3D[2,:], \
                       ...
                       forces3D[0,:], forces3D[1,:], time[-1]/optProb.N,\
                       goalX, goalY, goalPhi)
